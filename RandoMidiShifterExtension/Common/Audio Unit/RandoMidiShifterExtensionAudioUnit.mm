//
//  RandoMidiShifterExtensionAudioUnit.mm
//  RandoMidiShifterExtension
//
//  Created by Yuval Egozi on 01/01/2023.
//

#import "RandoMidiShifterExtensionAudioUnit.h"

#import <AVFoundation/AVFoundation.h>
#import <CoreAudioKit/AUViewController.h>
#import <CoreMIDI/CoreMIDI.h>

#import "RandoMidiShifterExtensionAUProcessHelper.hpp"
#import "RandoMidiShifterExtensionDSPKernel.hpp"


// Define parameter addresses.

@interface RandoMidiShifterExtensionAudioUnit ()
...
@implementation RandoMidiShifterExtensionAudioUnit {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    RandoMidiShifterExtensionDSPKernel _kernel;
...
- (void)setupParameterCallbacks {
    ...
    __block RandoMidiShifterExtensionDSPKernel *kernel = &_kernel;
