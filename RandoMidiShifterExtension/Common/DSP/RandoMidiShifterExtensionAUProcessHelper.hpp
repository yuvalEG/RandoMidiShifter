//
//  RandoMidiShifterExtensionAUProcessHelper.hpp
...
#include <vector>
#include "RandoMidiShifterExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(RandoMidiShifterExtensionDSPKernel& kernel)
    : mKernel{kernel} {}
...
private:
    RandoMidiShifterExtensionDSPKernel& mKernel;
};
