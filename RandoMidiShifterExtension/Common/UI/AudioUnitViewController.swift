...
private let log = Logger(subsystem: "Egozi.RandoMidiShifterExtension", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<RandoMidiShifterExtensionMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try RandoMidiShifterExtensionAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? RandoMidiShifterExtensionAudioUnit else {
            log.error("Unable to create RandoMidiShifterExtensionAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(RandoMidiShifterExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = RandoMidiShifterExtensionMainView(parameterTree: observableParameterTree)
